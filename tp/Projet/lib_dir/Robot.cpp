    ...
    for(;;){
        ...
        switch(etat){
            ...
            case END:
                ...
                if( abs(distTime2 - distTime1) < compare_value + (compare_value >> 2) + (compare_value >> 1) && droite){ 
                    PORTC = 0x10;
                } else if ( abs(distTime2 - distTime1) > compare_value + (compare_value >> 1) + (compare_value >> 2) && droite) {
                    PORTC = 0x08;
                } else if( (abs(distTime2 - distTime1)) < compare_value + (compare_value >> 1) + (compare_value >> 2) && !droite  ) {
                    PORTC = 0x04;
                } else {
